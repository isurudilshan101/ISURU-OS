;isuru --- The isuru Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE isuruos_VER '1.0.0'	 ;OS version number
	%DEFINE isuruos_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as isuruos and its programs
...
option_screen:
	...
	os_init_msg2		db 'ISURU_OS_Hardware Information', 0
	os_version_msg2		db 'Version ', isuruos_VER, 0

	dialog_string_1		db 'Welcome to isuruos Operating System', 0
...
os_draw_background1:
	...
	mov cx,10110010		; Colour: white text on brown background
